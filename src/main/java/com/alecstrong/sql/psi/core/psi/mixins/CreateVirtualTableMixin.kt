...
import com.github.xiaolyuh.sql.psi.SqlCreateVirtualTableStmt
import com.github.xiaolyuh.sql.psi.SqlModuleArgument
...
internal abstract class CreateVirtualTableMixin(
    ...
    override fun tableExposed(): LazyQuery {
        val columnNameElements = findChildrenByClass(SqlModuleArgument::class.java)
