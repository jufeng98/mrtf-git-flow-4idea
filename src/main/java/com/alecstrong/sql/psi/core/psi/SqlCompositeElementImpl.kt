...
internal open class SqlCompositeElementImpl(
    ...
    override fun toString(): String {
        ...
        return "${javaClass.simpleName}-${node.elementType}: ${(parent as SqlCompositeElement).queryAvailable(this)}"
    }
    ...
    override fun getContainingFile() = super.getContainingFile() as SqlFile
}