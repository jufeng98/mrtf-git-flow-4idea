...
class ConfigService(private val project: Project) {
    ...
    val kubesphereUser = Pair(
        preferences["kubesphereUsername", ""],
        preferences["kubespherePassword", ""]
    )
    ...
    private val fsWebHookUrl: String = preferences["fsWebHookUrl", ""]

    fun getKubesphereToken(): String {
        return if (isMhKubesphere()) {
            preferences["kubesphereToken", "abcd"]
        } else {
            preferences["kubesphereTokenGroup", "abcd"]
        }
    }
     ...
     * @param configJson configJson
     */
    fun saveConfigToFile(configJson: String?) {
    ...
    private fun getFromProjectWorkspace(): InitOptions? {
        ...
        if (StringUtils.isNotBlank(json)) {
            ...
            return HttpClientUtil.gson.fromJson(json, InitOptions::class.java)
        }
    ...
    private fun getFromProjectConfigFile(): InitOptions? {
        ...
        return HttpClientUtil.gson.fromJson(configJsonStr, InitOptions::class.java)
    }
    ...
    fun getPodsUrl(serviceName: String): String {
        ...
        return MessageFormat.format(
            ...
            serviceName.lowercase(Locale.getDefault())
        )
    }
    ...
    fun getLogsUrl(
        ...
        return MessageFormat.format(
            ...
            serviceName.lowercase(Locale.getDefault()), tailLines.toString() + "", follow, previous
        )
    }
    ...
    private fun getFromProjectK8sFile(): K8sOptions? {
        ...
        return HttpClientUtil.gson.fromJson(configJsonStr, K8sOptions::class.java)
    }
